var Hist = function(opts) {
    ...
    this.bins    = opts.bins;
    this.color   = opts.color || theColors[0] || "steelblue";//default color
    this.exists  = false;
    // create the Hist
...
Hist.prototype.draw = function() {
    ...
    this.setColor(this.color) //color the Hist.
}

Hist.prototype.createXScale = function(){
...
Hist.prototype.generateHist = function(){
...
Hist.prototype.createYScale = function(){
    this.yScale = d3.scale.linear()
        .domain([0, d3.max(this.hist_data, function(d) { return d.y; })])
        .range([this.height, 0]);
}

Hist.prototype.addAxes = function(){
...
Hist.prototype.updateAxes = function(){
...
Hist.prototype.drawHist = function(){
...
Hist.prototype.setColor = function(newColor) {
...
Hist.prototype.setData = function(newData) {
    this.data = newData;
    if (!this.exists || !this.data.length){
        this.draw();
        return
    }
    this.createXScale();
